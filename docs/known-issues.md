...
pair to equilibrium; the coolant path has no equivalent, and it is also the stiffest thing on a
plumbed grid. Measured at the shipped `Frequency` and clock: a reactor with nine plain blocks

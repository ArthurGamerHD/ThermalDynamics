...
| ~~A6~~ | ~~Convection reports 50 W/(m²·K) at zero air density.~~ **Done**, and it was not harmless: the density term was never applied to the transfer at all, so any atmosphere convected at the full sea-level rate. The stability estimator had it right and the transfer did not. | [known-issues.md](known-issues.md) |

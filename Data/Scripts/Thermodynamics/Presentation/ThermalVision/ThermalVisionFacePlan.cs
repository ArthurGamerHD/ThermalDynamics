...
{
    /// <summary>Exact shared-face elimination for disjoint, visible regions in near-to-far order.</summary>
    public sealed class ThermalVisionFacePlan
    {
        ...
        public void Build(IList<Region> regions, Vector3D eye)
        {
            ...
            for (int i = 0; i < regions.Count; i++)
                for (int axis = 0; axis < 3; axis++) for (int side = 0; side < 2; side++)
                {
                    ...
                    // Exact temperatures only: no visual quantization, merging tolerance or partial-face assumptions.
        ...
        /// <summary>View-independent adjacency. Only neutral exit faces may be skipped using these bits.</summary>

...
{
    /// <summary>Bounded close-block refinement over complete coarse coverage, shared by the native adapter and corpus evaluation.</summary>
    public sealed class ThermalVisionBlockDetail
    {
        ...
        public List<Region> Build(ThermalVisionRegionScan coarse, bool refine)
        {
            ...
            // Reserve ordering headroom. A failed refinement never damages coarse coverage.

...
{
    /// <summary>Grid-local scalar interpolation; created once per published field, never mixes grids.</summary>
    public sealed class ThermalVisionSmoothField
    {
        ...
        public float Sample(Vector3D point, float fallback)
        {
            ...
            // Compact-support weights prevent remote hot groups washing out local cooling.

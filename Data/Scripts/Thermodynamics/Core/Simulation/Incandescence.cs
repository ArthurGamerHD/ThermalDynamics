...
namespace Thermodynamics.Core
{
    ...
    /// way they read one on a real forge. A ramp defined as a fraction of each block's critical
    /// temperature would put the same colour on a block at 400 K and a block at 1,200 K and teach
    /// nothing; see [document-of-intent.md](../../../../../docs/document-of-intent.md),
    /// Natural feedback, where that is argued and where the earlier relative form is withdrawn.
    /// </para>
    ///
    /// <para>

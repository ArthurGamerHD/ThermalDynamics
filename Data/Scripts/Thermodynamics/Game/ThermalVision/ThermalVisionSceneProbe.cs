        ...
        private static void DrawScene()
        {
            ...
            if (refreshed)
            {
                ...
                for (int g = 0; g < grids.Count; g++)
                {
                    ...
                    {
                        // Bound discovery separately so a large grid cannot consume the entire draw budget.
            ...
            {
                // Reserve most of the frame for machinery; cheap hull tiles get a bounded first pass.
                ...
                for (int i = 0; i < SceneCandidates.Count; i++)
                {
                    ...
                    // Revalidate cached membership and bounds every draw, including moving grids.

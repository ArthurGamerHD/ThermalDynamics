...
namespace Thermodynamics
{
    public static partial class ThermalVisionProbe
    {
        ...
        // PostPP is submission-ordered, not sorted by camera distance. Keep RHF layout
        // and text measurement, but submit this HUD after our full-screen compositor.
        // Raising ZOffset only orders RHF siblings; it cannot order Session.Draw calls.
        ...
        // The same palette textures used by the world renderer, rather than a second palette.
        ...
        private static void UpdateVisionLegend()
        {
            ...
            // Framework layout can precede the current camera pose. Do not reuse its
            // cached PlaneToWorldRef here: this draw runs in the session callback.

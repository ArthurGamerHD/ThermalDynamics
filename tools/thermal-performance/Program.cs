...
// Deterministic headless dense, thin hull, sparse fleet and multi-cell fixtures.
...
// Differential checks across blur radii, density selection and nonuniform block sizes.
...
// Compare complete patch output to the frozen implementation across irregular boxes.
...
// Same vertices and triangle count: compare only celestial sampling CPU work.
...
// Match the live renderer's IList-returning face API; foreach boxes its enumerator.
...
// Transition preparation and near caps repeatedly sample the same small lattices.

...
namespace Thermodynamics.Core
{
    ...
    public static class WindField
    {
        ...
        public static float Speed(float maxSpeed, float weather, float variation, float weatherWind)
        {
            ...
            // Calm to storm on the weather, with a steady per-position spread. The kind's modifier
            // scales how fast the share climbs and cannot pass the far end. See environment.md, Circulation.

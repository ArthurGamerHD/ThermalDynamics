...
{
    /// <summary>Spatial ordering against independent ray intervals, field preservation and fragmentation bounds.</summary>
    public class ThermalVisionRegionOrderTests
    {
        ...
        public void HierarchicalFrustumTraversalMatchesOrderedLeafFilteringForMovingViews()
        {
            ...
            for(int i=0;i<80;i++)
            {
                ...
                {
                    // Independent eight-corner world bounds model the removed second check.
        ...
        public void SharedFacePlanPreservesHeatAndCoolingAlongIndependentRays()
        {
            ...
            // A culled neighbour must not leave a hole in the retained cell's boundaries.
        ...
        public void UniformThousandCellFieldNeedsOnlyItsOuterSixHundredFaces()
        {
            ...
            // Full-face equality is required; a smaller touching neighbour cannot erase a larger face.
        ...
        {
            // Grid acquired, looking into space, and acquisition on return all retain the effect.
            ...
            // Passive rendering persists throughout chat/cursor transitions; key handling is separate.
        ...
        {
            // At 100 m, these share a 40 m estimate. At 30 m they share a 10 m estimate.
            // Within the close band they resolve into distinct 2.5 m cells.

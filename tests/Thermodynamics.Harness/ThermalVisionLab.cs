...
{
    /// <summary>Engine-independent workload and software-depth lab; never claims game GPU validation.</summary>
    public static class ThermalVisionLab
    {
        ...
        /// <summary>Closed tessellated hull: actual non-overlapping geometry with six outward-facing sides.</summary>
        ...
        public sealed class Frame
        {
            ...
            // Independent barycentric depth oracle. Orthographic reference camera looks down -Z.
        ...
        {
            var frame = new Frame();
            // Same footprint: the hot rear surface must never leak through the cold front surface.
            if (reverse) { Quad(frame, 300, 0); Quad(frame, 750, -1); }
            else { Quad(frame, 750, -1); Quad(frame, 300, 0); }
            // A visible hot slope beside the opaque hull supplies palette contrast.
